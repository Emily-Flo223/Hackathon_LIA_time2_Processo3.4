...
| :--- | :---: | :--- |
| Consistência Financeira (Nó 4) | ❌ FALHA | O coordenador marcou que o projeto não teve recursos, mas a base oficial regista fomento de R$ 8,674.88. |
| Completude Estrutural (Nó 6) | ❌ FALHA | Campos ausentes: Atividades Realizadas |
| Carga Horária Geral (Nó 6) | ❌ FALHA | Soma das atividades (0 itens): 0h | Total declarado pelo coordenador: 124h |
