...
1. ⚠️ **E4: Ausência de campos ou seções obrigatórias no relatório. (Atividades Realizadas, Síntese da Execução)**
...
| Completude Estrutural (Nó 6) | ❌ FALHA | Campos ausentes: Atividades Realizadas, Síntese da Execução |
| Carga Horária Geral (Nó 6) | ❌ FALHA | Soma das atividades (0 itens): 0h | Total declarado pelo coordenador: 81h |
