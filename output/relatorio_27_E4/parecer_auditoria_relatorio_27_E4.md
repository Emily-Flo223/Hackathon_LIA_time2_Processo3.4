...
**Número do Relatório:** relatorio_27_E4
**Protocolo da Submissão:** Não identificado
**Título da Ação:** Capacitação em Primeiros Socorros para Comunidades Rurais
**Coordenador(a) Proponente:** César Monteiro
**Tipo de Relatório:** Final
**Data de Envio para Auditoria:** 27/03/2025
...
1. ⚠️ **E4: Ausência de campos ou seções obrigatórias no relatório. (Atividades Realizadas, Resultados Alcançados / Produtos)**
...
| :--- | :---: | :--- |
| Consistência Financeira (Nó 4) | ❌ FALHA | O coordenador marcou que o projeto não teve recursos, mas a base oficial regista fomento de R$ 17,055.98. |
| Completude Estrutural (Nó 6) | ❌ FALHA | Campos ausentes: Atividades Realizadas, Resultados Alcançados / Produtos |
| Carga Horária Geral (Nó 6) | ❌ FALHA | Soma das atividades (0 itens): 0h | Total declarado pelo coordenador: 151h |
