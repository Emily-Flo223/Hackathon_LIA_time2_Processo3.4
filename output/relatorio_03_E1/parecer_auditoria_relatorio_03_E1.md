...
**Número do Relatório:** relatorio_03_E1
**Protocolo da Submissão:** CCBS.292401
**Título da Ação:** Hortas Comunitárias e Segurança Alimentar
**Coordenador(a) Proponente:** Débora Correia
**Tipo de Relatório:** Parcial
**Data de Envio para Auditoria:** 26/05/2024
...
1. ⚠️ **Erro E1: Valor declarado diverge do concedido em mais de 1% (Divergência: 18.90%).**

### Matriz Analítica de Evidências Extraídas:
| Componente de Validação | Status da Inspeção | Detalhamento Técnico da Evidência |
| :--- | :---: | :--- |
| Consistência Financeira (Nó 4) | ❌ FALHA | Declarado: R$ 20,262.74 | Oficial: R$ 24,983.50 |
| Completude Estrutural (Nó 6) | ✅ OK | Relatório 100% completo. |
| Carga Horária Geral (Nó 6) | ✅ OK | Soma das atividades: 96h | Total declarado: 96h |
| Vínculo de Bolsistas (Nó 5) | ✅ OK | Bolsista 'Kelly Oliveira' validado com sucesso (Nome, Projeto e Vigência corretos). — Período Declarado: 12/02/2024 a 02/07/2025 | Vigência Oficial: 12/02/2024 a 02/07/2025 |
